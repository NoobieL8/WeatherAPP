...
let pRealFeel = document.createElement('p');
let pDesc = document.createElement('p');


function drawWeather(d) {
    let celcius = Math.round(parseFloat(d.main.temp)-273.15);
    let realFeel = Math.round(parseFloat(d.main.feels_like)-273.15);

    pTemp.innerHTML = celcius + '&deg; c';
    temp.appendChild(pTemp);

    pRealFeel.innerHTML = realFeel + '&deg; c';
    real_feel.appendChild(pRealFeel);
